...
//
//     final deleteOrderByIdModel = deleteOrderByIdModelFromJson(jsonString);

import 'dart:convert';

DeleteOrderByIdModel deleteOrderByIdModelFromJson(String str) => DeleteOrderByIdModel.fromJson(json.decode(str));

String deleteOrderByIdModelToJson(DeleteOrderByIdModel data) => json.encode(data.toJson());
...
class DeleteOrderByIdModel {
  ...
  factory DeleteOrderByIdModel.fromJson(Map<String, dynamic> json) => DeleteOrderByIdModel(
    id: json["id"],
