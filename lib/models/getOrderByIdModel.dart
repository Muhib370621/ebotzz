...
//
//     final getByIdOrderModel = getByIdOrderModelFromJson(jsonString);

import 'dart:convert';

GetByIdOrderModel getByIdOrderModelFromJson(String str) => GetByIdOrderModel.fromJson(json.decode(str));

String getByIdOrderModelToJson(GetByIdOrderModel data) => json.encode(data.toJson());

class GetByIdOrderModel {
  int id;
  int parentId;
  String status;
  String currency;
  ...
  factory GetByIdOrderModel.fromJson(Map<String, dynamic> json) => GetByIdOrderModel(
    id: json["id"],
