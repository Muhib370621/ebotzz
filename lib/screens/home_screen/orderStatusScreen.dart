                  ...
                  children: [
                    Expanded(
                      child: CustomActionButton(
                        ...
                        onTap: () {
                          productController
                              .deleteOrderByIdResponse(controller.text);
                          productController
                              .getOrderByIdResponse(controller.text);
                          if (productController.getOrderById["status"] ==
                              "trash") {
                            productController.getOrderStatus();
                            Get.snackbar(
                                "Successfully", "Deleted item Successfully!",
